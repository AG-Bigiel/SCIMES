...
def cloudstering(dendrogram, catalog, criteria, user_k, user_ams, user_scalpars, user_iter, 
    save_isol_leaves, save_clust_leaves, save_branches, blind, rms, s2nlim, locscal, n_jobs):
    ...
    return clusts, catalog, AMs, escalpars, silhoutte, n_jobs
...
class SpectralCloudstering(object):
    ...
    def __init__(self, dendrogram, catalog, header, criteria = ['volume', 'luminosity'],
        ...
        self.clusters, self.catalog, self.affmats, self.escalpars, self.silhouette, self.n_jobs= cloudstering(self.dendrogram,
                                                                                        catalog,
                                                                                        self.criteria,
                                                                                        self.user_k, 
                                                                                        self.user_ams, 
